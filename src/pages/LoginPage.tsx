...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.message || 'Failed to send link. Check your email and try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        {sent ? (
          <div className="flex flex-col items-center gap-3 py-4 text-center">
            ...
            <div>
              <p className="text-sm font-semibold" style={{ color: 'var(--tc-80)' }}>Check your email</p>
              <p className="text-xs mt-1" style={{ color: 'var(--tc-40)' }}>
                We sent a magic link to <span style={{ color: B }}>{email}</span>.
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              style={{
                background: loading || !email.trim() ? `${B}40` : B,
                color: '#fff',
            ...
            <p className="text-[10px] text-center" style={{ color: 'var(--tc-25)' }}>
