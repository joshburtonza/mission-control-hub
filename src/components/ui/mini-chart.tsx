          ...
          >
            ...
            <div
              ...
              style={{
                ...
                transform: isHovered ? 'scaleX(1.12) scaleY(1.02)' : isNeighbor ? 'scaleX(1.05)' : 'scaleX(1)',
              }}
            />

            {/* Label */}
            <span
              className="text-[9px] font-medium mt-1.5 transition-all duration-200 text-center"
              style={{
